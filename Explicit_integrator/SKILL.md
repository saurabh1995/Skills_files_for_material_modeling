...
Generate explicit time integration schemes for constitutive material models, particularly viscoplastic models with damage, following the radial return mapping algorithm pattern.
...
5. **Format as JAX-compatible Python code** following the reference template structure
...
def constitutive_update(self, eps, state, dt):
    ...
    # 7. CONDITIONAL BRANCHING (Algorithm 1, line 8)
    is_plastic = fy > 0.0
...
- **`references/code-template.md`** - Complete annotated template with all implementation steps
- **`references/equation-mapping.md`** - Maps common constitutive equations to code
- **`references/example-models.md`** - Full implementations of classic models
